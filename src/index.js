...
async function handleLookup(ctx, raw, vehicleType = '1') {
  ...
  const wait = await ctx.reply(`🔎 [${VERSION}] Đang tra cứu ${plate} trên phatnguoi.vn hiện tại...`);
  try {
